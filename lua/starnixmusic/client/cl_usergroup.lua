...
local function confirmationPanel(target, refreshList)
    ...
    confirmationPanelTitle:SetText(StarnixMusic.Language["music.menu.confirmationDelete"])
    ...
    TEXT CONFIRMATION
    ---------------------------------------------------------------------------]]
    local textToFormat = StarnixMusic.Language["music.menu.confirmationDeleteText"]
    ...
    confirmationPanelButtonYes:SetText(StarnixMusic.Language["music.menu.confirmationYes"])
    ...
    confirmationPanelButtonYes.DoClick = function()
        LocalPlayer():PrintMessage(HUD_PRINTTALK, StarnixMusic.Language["music.menu.wl.removemsg1"] .. target:Nick() .. StarnixMusic.Language["music.menu.wl.removemsg2"])
    ...
    confirmationPanelButtonNo:SetText(StarnixMusic.Language["music.menu.confirmationNo"])
...
local function refreshList(usergroupsPanel, panelList, combobox)
    ...
    for k, v in pairs(tableWhitelistedPly) do
        ...
        if k ~= LocalPlayer() then
            ...
            pListPanelButtonRemove:SetText(StarnixMusic.Language["music.menu.wl.remove"])
...
function StarnixMusic.drawGroups()
    ...
    usersPanelTitle:SetText(StarnixMusic.Language["music.menu.usersTitle"])
    ...
    combobox:SetValue(StarnixMusic.Language["music.menu.wl.selectPly"])
    ...
    pListPanelButtonAdd:SetText(StarnixMusic.Language["music.menu.wl.add"])
    ...
    pListPanelButtonAddAll:SetText(StarnixMusic.Language["music.menu.wl.addall"])
    ...
    pListPanelButtonAddForceText:SetText(StarnixMusic.Language["music.menu.admin.force"])
    ...
    net.Receive("Music_MenuGetWhitelisted", function()
        isConcerningOnePlayer = net.ReadBool()
        if isConcerningOnePlayer then
            table.insert(tableWhitelistedPly, net.ReadEntity())
        else
            maxPlayersWhitelisted = net.ReadUInt(8)
            tableWhitelistedPly = net.ReadTable()
        end
            
        refreshList(usergroupsPanel, panelList, combobox)
    end)
end