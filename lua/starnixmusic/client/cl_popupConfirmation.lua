...
local function confirmationPopupPanel(playerRequesting, musicName)
    ...
    confirmationPanelTitle:SetText(StarnixMusic.Language["music.menu.popup.musicAdd.title"])
    ...
    confirmationPanelText:AppendText(StarnixMusic.Language["music.menu.popup.musicAdd.text"])
    confirmationPanelText:InsertColorChange(192, 57, 43,255)
